...
object HTElements {
    ...
    @JvmField
    val Ag = HTElement.of(
        ColorConvertible.average(HTColor.AQUA to 1, HTColor.WHITE to 3),
        "Ag",
        107.9,
    )
    ...
    @JvmField
    val Sn = HTElement.of(
        ColorConvertible.average(HTColor.BLUE to 1, HTColor.AQUA to 1, HTColor.WHITE to 3),
        "Sn",
        118.7,
    )
    ...
    @JvmField
    val W = HTElement.of(
        ColorConvertible.average(HTColor.BLACK to 2, HTColor.DARK_GRAY to 1),
        "W",
        183.8,
    )
    ...
    @JvmField
    val Pb = HTElement.of(
        ColorConvertible.average(HTColor.DARK_BLUE, HTColor.DARK_GRAY, HTColor.WHITE),
        "Pb",
        207.2,
    )
