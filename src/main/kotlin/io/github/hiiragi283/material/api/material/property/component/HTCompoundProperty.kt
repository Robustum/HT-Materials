...
class HTCompoundProperty(map: Map<HTMaterialKey, Int>) :
    HTComponentProperty<HTCompoundProperty>,
    ...
    override fun asColor(): Color = ColorConvertible.average(this.mapKeys { (key: HTMaterialKey, _) -> HTMaterial.getMaterial(key).color })
